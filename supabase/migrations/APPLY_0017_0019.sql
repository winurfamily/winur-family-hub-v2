-- =====================================================================
-- Winur Family Hub V2 — Migration keuangan 0017 + 0018 + 0019
-- Gabungan untuk ditempel sekali jalan di Supabase SQL Editor.
-- Seluruh isinya ADDITIVE & idempotent: tidak ada DROP TABLE, tidak ada
-- DELETE data, dan aman dijalankan ulang.
-- =====================================================================


-- ############ migrations/0017_finance_core.sql ############
...
-- ############ migrations/0018_shopping_structure.sql ############
...
-- ############ migrations/0019_receipts_storage.sql ############
