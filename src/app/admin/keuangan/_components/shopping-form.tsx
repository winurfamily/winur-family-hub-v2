...
import { EXPENSE_CATEGORIES, EXPENSE_CATEGORY_LABELS, type ShoppingTransactionSource } from "@/lib/supabase/types";
...
/**
 * Form satu transaksi belanja: header (toko, tanggal, sumber dana, kategori,
 * catatan, struk) + daftar barang. Dipakai oleh input manual maupun layar
 * review hasil Scan AI, supaya keduanya punya validasi & perilaku simpan
 * yang persis sama.
 */
export function ShoppingForm({
  ...
  const handleSubmit = (event: React.FormEvent) => {
    ...
    startTransition(async () => {
      ...
      router.push(`/admin/keuangan/belanja/${result.data.id}`);
    });
  };
    ...
    <form onSubmit={handleSubmit} className="space-y-4" noValidate>
      <section className="space-y-3.5 rounded-[20px] bg-card p-4 shadow-card sm:p-5">
        ...
        <div className="grid gap-3.5 sm:grid-cols-2">
          ...
          <div className="space-y-1.5">
            <Label htmlFor="shop-category">Kategori pengeluaran</Label>
